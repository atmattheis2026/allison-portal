-- The Qualification card (preapproval, budget, purchase type, cash/
-- financing, has-a-house-to-sell) becomes client-visible — buyer broker
-- signed/expiration dates stay internal-only, untouched, and live in a
-- different card entirely so this doesn't risk pulling them in too.
