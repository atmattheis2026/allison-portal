-- The app needs to know WHICH roster member is the realtor, not just their
-- resolved name/license/headshot, so the "pick a realtor" dropdown can show
-- the current selection instead of guessing by matching names.
